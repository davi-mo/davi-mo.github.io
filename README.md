# Resume of Davi Menezes de Oliveira

This is the CV for Davi Menezes de Oliveira. This theme features a fixed sidebar with content sections to build a simple, yet elegant resume.
